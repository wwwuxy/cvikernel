...
or_param.res = tl_output;
or_param.a = tl_input1;
or_param.b = tl_input2;
or_param.layer_id = 0;
...
ctx->ops->tdma_l2g_tensor_copy(ctx, &param3);
    ...
    uint8_t result = value1 | value2;  // 0x3F (二进制: 00111111)
    
    // 打印示例结果
    printf("示例结果: 0x%02X | 0x%02X = 0x%02X\n", value1, value2, result);
    printf("二进制表示: %s | %s = %s\n", 
           "00001111", "00110011", "00111111");
