...
// cv1880v2优化的张量大于等于比较函数
void cv1880v2_tensor_ge(int8_t *input1, int8_t *input2, int8_t *output, 
...
void test_tiu_ge() {
    ...
    compare_param.type = CVK_TIU_COMPARE_GE;  // 大于等于比较
...
// 使用TIU API测试与常量比较的大于等于
void test_tiu_ge_constant() {
    printf("测试 CV1880V2 TIU 常量大于等于运算...\n");
    ...
    printf("TIU常量大于等于测试通过!\n");
}

int main() {
    printf("运行cv1880v2 TIU大于等于测试...\n");
