...
ctx->ops->tdma_l2g_tensor_copy(ctx, &param3);
    ...
    printf("模拟TIU张量按位异或运算...\n");
    printf("创建形状为[1,4,4,4]的张量\n");
    printf("将输入1设为: 0x55 (二进制: 01010101)\n");
    printf("将输入2设为: 0xAA (二进制: 10101010)\n");
    printf("执行TIU按位异或操作\n");
    printf("期望结果: 0xFF (二进制: 11111111)\n");
